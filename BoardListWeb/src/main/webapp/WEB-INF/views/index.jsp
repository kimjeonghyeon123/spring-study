...
<body>
    ...
    <article class="main-about">
        <div class="main-btn" width="80%" height="auto">
            <button type="button" id="main-btn" name="petsitter"><a href="">댕근마켓 바로가기▶</a></button>
            <button type="button" id="main-btn" name="pet"><a href="">댕댕케어 바로가기▶</a></button>
        </div>
        <br>
    </article>
    <br><br>
    <footer class="main-about-img">
        <img src="./image/about.png" width="100%" height="auto">
    </footer>
    <br><br><br><br>
