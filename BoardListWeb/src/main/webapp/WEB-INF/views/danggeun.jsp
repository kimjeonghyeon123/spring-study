	                    ...
	                    <div class="card h-100">
	                        ...
	                        <div class="card-body p-4">
	                            <div class="text-center">
	                                <!-- Product name-->
	                                <h5 class="fw-bolder"><a href="<c:url value='/danggeun/view?id=${danggeundto.id}&type_id=${type_id}' />">${danggeundto.title}</a></h5>
	                                <!-- Product price-->
	                                ${danggeundto.price}원
	                                <li id="user-adress"><a>${danggeundto.local_id}</a></li>
	                                <li id="user-name"><a>${danggeundto.writer_name}</a></li>
