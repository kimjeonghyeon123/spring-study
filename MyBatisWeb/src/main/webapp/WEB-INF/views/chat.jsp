...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#chatrooms").on('click', '.chatroom', function(){
        	...
        	showChattingAndList2(chatroomId)
    ...
    async function showChattingAndList2(chatroomId) {
    	try {
    ...
    async function showChattingAndList3(chatroomId) {
    	try {
    		await showChattingList(chatroomId)
    		await showList()
		...
		ws.onmessage = function(event) {
		    ...
		    if (cmd === "sendchat") {
		    	...
		    	if(String(message.chatroomId) === chatroomId) {
		    		showChattingAndList3(chatroomId)
		    	}
		    	else {
		    		showList()
		    	}
