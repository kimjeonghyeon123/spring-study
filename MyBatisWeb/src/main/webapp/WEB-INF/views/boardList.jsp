...
<body>
    ...
    <div id="modal" style="display: none; background-color: red; width:100px; height: 25px;">
    	성공!!
    </div>
    			...
    			<div class="paging">
    				...
    				<c:if test="${totalCnt != null || totalCnt != 0 }">
    					...
    					<c:forEach var="i" begin="${pr.beginPage }" end="${pr.endPage }">
    						<a class="page" href="<c:url value="/board/list${pr.sc.getQueryString(i) }" />" style="${pr.sc.page == i ? 'text-decoration: underline;' : ''}"}>${i }</a>
    					</c:forEach>
