...
public interface ChattingService {
	...
	//채팅 목록 불러오기
	List<ChatChattingDTO> readChatting(Integer chatroom_id, String login_nickname, String other_nickname) throws Exception;
	...
	int countUnreadChat(String login_nickname) throws Exception;
