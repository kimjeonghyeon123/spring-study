                ...
                <section class="dangguen-sec">
                    ...
                    <div id="select-address">
						...
						<div class="img-sec" style="display: flex;">
						    <input id="imageinput1" name="images" type="file" accept=".jpg, .jpeg, .png" onchange="previewImage(this, 0)" style="display: none;">
						    <label for="imageinput1" style="display: block; width: 100px; height: 20px">이미지 선택 1</label>
						    <input id="imageinput2" name="images" type="file" accept=".jpg, .jpeg, .png" onchange="previewImage(this, 1)" style="display: none;">
						    <label for="imageinput2" style="display: block; width: 100px; height: 20px">이미지 선택 2</label>
						    <input id="imageinput3" name="images" type="file" accept=".jpg, .jpeg, .png" onchange="previewImage(this, 2)" style="display: none;">
						    <label for="imageinput3" style="display: block; width: 100px; height: 20px">이미지 선택 3</label>
						</div>
		                <div id="preview-list">
		                	<c:forEach var="photo" items="${photoList}" varStatus="loop">
							    <img src="${photo.address}" style="width: auto; height: 100px; margin-right: 10px;"/>
							    <input type="hidden" name="origin_image${loop.index+1}" value="${photo.address}">
							</c:forEach>
		                </div>
...
<script type="text/javascript">    
	...
	let formCheck = function(frm) {
	    ...
	    if (frm.find('input[id="imageinput1"]').get(0).files.length === 0) {
	        alert('사진을 선택해주세요.');
	        return false;
	    }
