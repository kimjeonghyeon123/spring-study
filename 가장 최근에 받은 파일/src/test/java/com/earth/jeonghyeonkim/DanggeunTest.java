...
public class DanggeunTest {
	...
	public void insertTest() throws Exception {
		for(int i = 1; i <= 10; i++) {
			DanggeunDTO danggeunDTO = new DanggeunDTO("hi" + i, "hi" + i, 1, 1, 1000, "hihi", "gojhkim123@naver.com");
			danggeunDAO.insert(danggeunDTO);
		}
		for(int i = 11; i <= 20; i++) {
			DanggeunDTO danggeunDTO = new DanggeunDTO("hi" + i, "hi" + i, 2, 1, 1000, "hihi", "gojhkim123@naver.com");
			danggeunDAO.insert(danggeunDTO);
		}
	}
