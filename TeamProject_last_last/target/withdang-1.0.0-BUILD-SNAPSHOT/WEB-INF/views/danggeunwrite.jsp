            ...
            <div class="board_write">
                ...
                <section class="dangguen-sec">
                    ...
                    <div id="select-address">
                        ...
                        <div class="img-sec">
                            <input id="imageinput1" name="image1" type="file" accept=".jpg, .jpeg, .png" onchange="previewImage(this, 0)">
		                    <input id="imageinput2" name="image2" type="file" accept=".jpg, .jpeg, .png" onchange="previewImage(this, 1)">
                            <input id="imageinput3" name="image3" type="file" accept=".jpg, .jpeg, .png" onchange="previewImage(this, 2)">
                        </div>
