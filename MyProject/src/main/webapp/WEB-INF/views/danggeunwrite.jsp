...
<body>
    ...
    <div class="board_wrap">
        ...
        <form class="board_write_wrap" action="<c:url value='/danggeun/write' />" method='post' onsubmit="return formCheck(this)" style="display: flex; flex-direction: column;">
            <div class="board_write">
                <div class="title">
                    <dl>
                        <dd><input type="text" name="title" value="${DanggeunDTO.title}" placeholder="제목 입력" required></dd>
                    </dl>
                </div>
                <section class="dangguen-sec">
                    <div class="info">
                        <dl>
                            <dd><input type="number" name="price" value="${DanggeunDTO.price}" placeholder="판매 가격" required></dd>
                        </dl>
                        <div id="dangguen-img">
			           	<select class="form-select" aria-label="category" name="type_id">
			                    <c:forEach var="DanggeunTypeDTO" items="${typeList}">
			                    	<option value="${DanggeunTypeDTO.id}">${DanggeunTypeDTO.name}</option>
			                    </c:forEach>
			            </select>
            ...
            <div class="bt_wrap">
                ...
                <button class="list-btn" id="listBtn" type="button">목록</button>
            </div>
        </form>
    </div>
	...
	$(document).ready(function(){
        ...
        $('#sigoon_code').on('change', function(){
   		...
   		$('#listBtn').on('click', function(){
   			location.href = '<c:url value="/danggeun/list${danggeunSearchItem.queryString}" />'
   		})
	})
</script>    
</body>
