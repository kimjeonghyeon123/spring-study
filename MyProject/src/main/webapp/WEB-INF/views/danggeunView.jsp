        ...
        <div class="board_view_wrap">
            <div class="board_view">
                <div class="info">
                    ...
                    <dl>
                        <dt>위치</dt>
                        <dd>${danggeunDTO.location_name}</dd>
                    </dl>
                    <dl>
                        <dt>조회</dt>
            ...
            <div class="bt_wrap">
                ...
                <a id="chat-btn" href="chat.html" class="on">채팅</a>
                <a id="list-btn" href="<c:url value='/danggeun/list' />">목록</a>
                <c:if test="${danggeunDTO.writer_email != loginEmail}">
...
<script type="text/javascript">
    $(document).ready(function(){
    	$(".delete_btn").on('click', function(){
			...
			$.ajax({
				type: 'post',
				url: '/danggeun/danggeun/remove',
				data: {
					'id': id 
				},
				success: function(response) {
					location.href = "<c:url value='/danggeun/list' />"
				},
				error: function(){
					alert('error')
				}
